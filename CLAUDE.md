...
- 청킹: 규정원문 **제N조 단위**, 가이드/ERP는 **헤딩(####/##) 단위**(02의 `chunk_guide`) (고정 길이 청킹 금지)
...
- ERP:    `python tools/01d_erp_to_md.py --src KEI_ERP_entire_features.md --vault KEI-행정가이드`  (ERP 기능분석 → 10_업무가이드/ERP/ 모듈별 노트, 분류:ERP시스템, #### 기능 단위 청킹)

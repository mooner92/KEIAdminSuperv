...
| 품질 강화 | ✅ P1.1~P1.4(VLM 제외) | 평가 하베스트+면책 가드레일 100%+검수 큐/도구. 별표 1급 청크(별표 0/4→4/4). **리랭커 적용 strict Hit@1 0.600→0.829·@5 1.000**(GPU1). 하이브리드는 이득無→off. 남음: P1.3 VLM 표복원(다운로드 승인 대기) ([12](12-품질강화.md)) |

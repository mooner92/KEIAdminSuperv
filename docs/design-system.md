...
| **2026-07-28** | **v2 Spotify 리디자인 착수**(`design/horong-v2/`, feat/spotify-v2) — 다크 기본·웜 차콜 3단·단색 앰버·사이드바 2패널 셸(GNB/푸터 폐지)·온디맨드 근거 패널·고밀도 트랙리스트·글자 커버 타일(이모지 폐기). P3·P7 개정. 소개/랜딩은 현행 구성 유지(사용자 확정) |

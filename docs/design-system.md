...
> ⚠ **v2(Spotify 리디자인) 진행 중** — `feat/spotify-v2` 브랜치(3101 검증). 원본 명세 =
> [`../design/horong-v2/`](../design/horong-v2/). 아래 v1 기술 중 **다크 기본·앰버 단색·
> 플로팅 패널 셸·고밀도 트랙리스트**가 v2에서 바뀐 핵심이다(P3·P7 개정, §7 이력 참조).
> dev 병합 시 이 문서를 v2 기준으로 전면 갱신한다.

...
| 컬렉션명 | `kei_regs` |
| 적재 규모(실측) | **수천 청크 규모** — 4섹션·296문서(규정원문 112 · 가이드 66 · 용어집 85 · **사내 시스템 33** — ERP·통합정보시스템(EIP)·연구관리시스템(PMS)·웹메일·그룹웨어·웹디스크·전자도서관 7개 시스템). 별표/별지 1급 청크(P1.3)·긴 조문 하위청킹(P2.3) 반영분 포함 |

...
<img src="docs/img/gif/01-질문하기.gif" alt="질문하기 — 상황 칩을 고르거나 평소 말투로 질문을 입력해 근거가 달린 답변을 받는 흐름">
<br/><sub><b>질문하기</b> — 평소 말투로 물으면 사내 문서를 근거로 답하고, 답 끝에 <code>[규정명 제N조]</code> 출처가 붙습니다. 근거에 없으면 "규정에서 확인되지 않습니다"라고 답합니다.</sub>
</td>
<td width="50%" valign="top">
<img src="docs/img/gif/03-문서-찾기.gif" alt="문서 찾기 — 검색어를 넣고 구분·분류·검수상태 필터로 좁히는 흐름">
<br/><sub><b>문서 찾기</b> — 구분·분류·검수상태 필터(패싯 카운트) + 제목·내용 전문검색. 행을 누르면 페이지 이동 없이 우측 드로어로 원문이 열립니다.</sub>
</td>
</tr>
<tr>
<td width="50%" valign="top">
<img src="docs/img/gif/11-여비-계산기.gif" alt="여비 계산기 — 국내/국외·직급·출장 유형·일수를 골라 정액표를 확인하는 흐름">
<br/><sub><b>여비 계산기</b> — 조건을 고르면 <b>규정 별표의 정액을 원문 그대로</b> 보여 줍니다. 곱셈(정액×일수)만 하고, 실비 항목은 금액을 만들지 않고 <code>실비</code>로 표시합니다.</sub>
</td>
<td width="50%" valign="top">
<img src="docs/img/gif/07-업무-한-장.gif" alt="업무 한 장 — 업무를 고르면 신청·결재·정산·보고 단계가 펼쳐지는 흐름">
<br/><sub><b>업무 한 장</b> — 출장·연차·법인카드 등 자주 하는 업무를 신청 → 결재 → 정산 → 보고까지 한 장으로. 단계마다 근거 조문·ERP 화면·필요 서식이 함께 붙습니다.</sub>
</td>
</tr>
</table>

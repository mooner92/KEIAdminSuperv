...
## 베이스라인 (참고 · 2026-06-20, KURE-v1 + Chroma, 31문항)
...
해석: 올바른 **규정**은 거의 top-1(0.903)에서 잡히고, 정확한 **조**는 top-3(0.935)/top-5(1.000)에서 회수.
strict@1(0.677) ↔ relaxed@1(0.903) 격차가 리랭커(P1.4) 개선 목표 지점.

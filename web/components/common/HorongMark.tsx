...
/** 호롱 브랜드 마크(design_handoff_horong) — 잎·물방울·불꽃 심볼.
 * 정적 물방울 실루엣 + 내부 잎맥, 불은 그라데이션만으로 표현(움직임 없음).
 * gradient id는 useId로 유일화 — 같은 페이지 다중 렌더 시 id 충돌 방지(핸드오프 주의). */
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" aria-label="호롱">
      ...
      <path d="M32.5 4.5 C 31 12 24.5 17.5 20 23.5 C 15.5 29.5 13.5 35 14.5 41
               C 16 51 23.5 57.5 32 57.5 C 40.5 57.5 48 51 49.5 41
               C 50.5 35 48.5 29.5 44 23.5 C 39.5 17.5 34 12 32.5 4.5 Z"
        fill={`url(#${gid})`} />

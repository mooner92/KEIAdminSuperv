...
const FAQ: { q: string; a: ReactNode; hidden?: boolean }[] = [
  ...
  },
  {
    ...
    a: (
      <>
        답변은 화면 하단의 <b>문서 기준일({CORPUS_AS_OF})</b> 시점 원문을 근거로 해요 — 이후 개정은
      ...
      <div className={h.body}>
        <section id="intro" className={h.section}>
          ...
          <ul>
            ...
            <li><b><Link href="/browse/">문서 찾기</Link></b> — 한 화면에서 <b>문서</b>(원문 검색·필터)·<b>서식</b>(별지 서식)·<b>그래프</b>(문서 간 연결)를 탭으로 오가며 봅니다.</li>
        ...
        <section id="limits" className={h.section}>
          <h2>한계 — 꼭 알아두세요</h2>
          <ul>
            <li>답변은 <b>{CORPUS_AS_OF} 기준 행정 문서</b>를 근거로 자동 생성됩니다 — 이후 개정은 반영되지 않았을 수 있어요.</li>
            <li>“규정에서 확인되지 않습니다”라는 답은 <b>문서에 근거가 없다는 뜻</b>입니다(도구가 지어내지 않도록 설계). 행정 용어로 바꿔 다시 묻거나 담당 부서에 문의하세요.</li>

...
/** 심볼이 겹쳐 담은 세 가지 */
const MEANINGS = [
  { emoji: "💧", title: "물방울", body: "행정 문서라는 큰 흐름에서 지금 내게 필요한 한 방울만 떠서 건넵니다. 전문을 다 읽지 않아도 되도록." },
...
const SECTIONS = [
  { name: "규정", hex: "#4f8dc4" }, { name: "가이드", hex: "#35906a" },
...
const PRINCIPLES = [
  ...
  { n: "04", title: "읽기 쉬움이 먼저입니다",
    body: "표에 빽빽하게 밀어넣기보다 한 줄에 하나씩. 규정·지침처럼 긴 글을 읽는 화면이라 글자 크기와 줄 간격을 넉넉히 잡았습니다." },
  { n: "05", title: "어두운 화면도 같이 만듭니다",
    body: "밝은 화면에서 만든 색을 그대로 뒤집지 않고, 어두운 화면용 색을 따로 골랐습니다. 기본값은 컴퓨터 설정을 따라가요." },
  { n: "06", title: "밖으로 나가지 않습니다",
    body: "글꼴·아이콘까지 전부 원내 서버에 두고 씁니다. 외부 서비스를 부르지 않으니 문서 내용이 밖으로 새어 나갈 길이 없습니다." },
];
        ...
        <div className={s.wrap}>
          ...
          <section className={s.hero}>
            ...
            <h1 className={s.heroTitle}>
              어두운 행정 문서를 <span className={s.grad}>호롱불</span>처럼
            </h1>
            <p className={s.heroLead}>
              호롱은 등잔에 불을 밝히던 옛 등불입니다. 방 전체를 환하게 비추진 못해도,
              지금 손에 든 것을 읽기에는 충분하죠. 이 서비스가 하려는 일도 같습니다 —
              문서 전체를 외우게 하는 대신, 지금 하려는 업무에 필요한 부분만 비춥니다.
            </p>
          </section>
